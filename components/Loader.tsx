...
const Loader: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center bg-white/50 rounded-lg">
      ...
      <h3 className="mt-4 text-lg font-semibold text-slate-700">Analyzing Property...</h3>
      <p className="text-sm text-slate-500">Our AI is inspecting your images. This may take a moment.</p>
    </div>
  );
};
